...
const palavrasProibidas = [
    ...
    "vagabundo","vagabunda","filho da puta","filha da puta","cretino","cretina",
    "arrombado","arrombada","desgraçado","desgraçada","merda","porra","puta",
    "piranha","pau no cu","cu","caralho","pinto","rola","piroca","buceta","cacete",
    "bosta","foda-se","vai se foder","vai tomar no cu","vai se lascar","vai à merda","macaca","macaco","estuprada","molestada"
];
...
// Converte palavras proibidas em regex para detectar camuflagem
const regexOfensiva = palavrasProibidas.map(palavra => {
    const regexString = palavra
        .replace(/\s+/g, "\\s*") // permite espaços entre palavras
        .split("").join("\\W*"); // permite caracteres entre letras
